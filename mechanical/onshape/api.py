...
Modified from Onshape's apikey package: https://github.com/onshape-public/apikey
'''
...
class Onshape():
    ...
    def __init__(self, stack=None, creds=None, logging=False):
        '''
        ...
        if creds is None:
            creds = Path.home() / '.config' / 'onshapecreds.json'
